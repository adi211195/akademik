			<div id="content-container">
                ...
                $page_print="pages/print/schedules.php";
                $back="page.php?p=schedules";
                $action="pages/dosen/schedules/action.php";
					                ...
					                <div class="panel-body">
					                    ...
					                    <div class="table-responsive">
					                        <table class="table table-striped">
					                            ...
					                            <thead>
					                                <tr>
					                                    <th colspan="5"><?= $day['day']; ?></th>
					                                </tr>
					                            </thead>
					                            <tbody>
					                            	<?php
					                            	$no=1;
					                            	$data2=mysqli_query($connect, "SELECT * FROM 
					                            		...
					                            		mc.curriculum_semester='$open_sm' AND 
