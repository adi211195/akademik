			<div id="content-container">
                ...
                $action="pages/dosen/view_profile/action.php";
                $account            =mysqli_fetch_array(mysqli_query($connect,"SELECT * FROM account where account_id='$account_id'"));
                $lecturer            =mysqli_fetch_array(mysqli_query($connect,"SELECT * FROM master_lecturer where account_id='$account_id'"));
					                            ...
					                            <div id="demo-bv-tab2" class="tab-pane">
					                                ...
					                                <div class="form-group">
					                                    ...
					                                    <div class="col-lg-9 pad-no">
					                                        <div class="clearfix">
					                                            <div class="col-lg-4">
					                                            	<?= $lecturer['lecturer_place_birth']; ?>
					                                            </div>
					                                            <div class="col-lg-4">
					                                            	<?= $lecturer['lecturer_date_birth']; ?>
					                                            </div>
					                                        </div>
					                                    </div>
					                                </div>
