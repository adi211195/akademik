                      <button type="button" class="btn btn-info btn-xs" data-toggle="modal" data-target="#Modalseminar"><i class="fa fa-upload"></i> Upload File</button><br><br>
                        <!-- Modal -->
                        <div id="Modalseminar" class="modal fade" role="dialog">
                          <div class="modal-dialog">
                        
                            <!-- Modal content-->
                            <div class="modal-content">
                              <div class="modal-header">
                                <h4 class="modal-title">Upload File Seminar</h4>
                              </div>
                              <form class="form-horizontal action" method="POST" enctype="multipart/form-data">
                              <input type="hidden" name="student_skpi_file_status" value="seminar">
                        ...
                        ?>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <button type="button" class="btn btn-primary btn-xs" data-toggle="modal" data-target="#seminaredit<?= $no; ?>"><i class="fa fa-edit"></i></button>
                                    ...
                                    <button type="button" class="btn btn-success btn-xs" data-toggle="modal" data-target="#seminar<?= $no; ?>"><i class="fa fa-eye"></i></button>
                                
                                    <!-- Modal -->
                                    <div id="seminaredit<?= $no; ?>" class="modal fade" role="dialog">
                                      <div class="modal-dialog">
                                    
                                        <!-- Modal content-->
                                        <div class="modal-content">
                                          <div class="modal-header">
                                            <h4 class="modal-title">Edit File Seminar</h4>
                                          </div>
                                          <form class="form-horizontal action" method="POST" enctype="multipart/form-data">
                                          <input type="hidden" name="student_skpi_file_status" value="seminar">
                                ...
                                <!-- Modal -->
                                    <div id="seminar<?= $no; ?>" class="modal fade" role="dialog">
                                      <div class="modal-dialog">
                                    
                                        <!-- Modal content-->
                                        <div class="modal-content">
                                          <div class="modal-header">
                                            <h4 class="modal-title">Detail File Seminar</h4>
                                          </div>
