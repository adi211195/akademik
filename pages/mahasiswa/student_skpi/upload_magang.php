                      <button type="button" class="btn btn-info btn-xs" data-toggle="modal" data-target="#Modalmagang"><i class="fa fa-upload"></i> Upload File</button><br><br>
                        <!-- Modal -->
                        <div id="Modalmagang" class="modal fade" role="dialog">
                          <div class="modal-dialog">
                        
                            <!-- Modal content-->
                            <div class="modal-content">
                              <div class="modal-header">
                                <h4 class="modal-title">Upload File Magang</h4>
                              </div>
                              <form class="form-horizontal action" method="POST" enctype="multipart/form-data">
                              <input type="hidden" name="student_skpi_file_status" value="magang">
                        ...
                        ?>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <button type="button" class="btn btn-primary btn-xs" data-toggle="modal" data-target="#magangedit<?= $no; ?>"><i class="fa fa-edit"></i></button>
                                    ...
                                    <button type="button" class="btn btn-success btn-xs" data-toggle="modal" data-target="#magang<?= $no; ?>"><i class="fa fa-eye"></i></button>
                                
                                    <!-- Modal -->
                                    <div id="magangedit<?= $no; ?>" class="modal fade" role="dialog">
                                      <div class="modal-dialog">
                                    
                                        <!-- Modal content-->
                                        <div class="modal-content">
                                          <div class="modal-header">
                                            <h4 class="modal-title">Edit File Magang</h4>
                                          </div>
                                          <form class="form-horizontal action" method="POST" enctype="multipart/form-data">
                                          <input type="hidden" name="student_skpi_file_status" value="magang">
                                ...
                                <!-- Modal -->
                                    <div id="magang<?= $no; ?>" class="modal fade" role="dialog">
                                      <div class="modal-dialog">
                                    
                                        <!-- Modal content-->
                                        <div class="modal-content">
                                          <div class="modal-header">
                                            <h4 class="modal-title">Detail File Magang</h4>
                                          </div>
