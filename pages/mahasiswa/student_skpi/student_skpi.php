			<div id="content-container">
                <div id="page-head">
                    ...
                    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                    <div id="page-title">
                        <h1 class="page-header text-overflow">SKPI</h1>
                    </div>
                    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                    <!--End page title-->
                ...
                $page_input="page.php?p=student_skpi&act=input";
                $page_detail="page.php?p=student_skpi&act=detail";
                $back="page.php?p=student_skpi";
                $action="pages/mahasiswa/student_skpi/action.php";
					        ...
					        <div class="col-xs-12">
					            <div class="panel">
					                <div class="panel-heading">
					                    <h3 class="panel-title">SKPI Data </h3>
					                </div>
					                    ...
					                    <div class="table-responsive">
						                    <table class="table" style="color:black;">
							                    ...
							                    <tr>
							                        ...
							                        <?php include "pages/mahasiswa/student_skpi/upload_prestasi.php"; ?>
							                    ...
							                    <tr>
							                        ...
							                        <?php include "pages/mahasiswa/student_skpi/upload_penghargaan.php"; ?>
							                    ...
							                    <tr>
							                        ...
							                        <?= $skpi['seminar_ind']; ?>
									                <?php include "pages/mahasiswa/student_skpi/upload_seminar.php"; ?>
									                </td>
							                    ...
							                    <tr>
							                        ...
							                        <?= $skpi['organisasi_ind']; ?>
								                    <?php include "pages/mahasiswa/student_skpi/upload_pengalaman.php"; ?>
								                	</td>
							                    ...
							                    <tr>
							                        ...
							                        <?= $skpi['tugas_akhir_ind']; ?>
								                    <?php include "pages/mahasiswa/student_skpi/upload_tugas_akhir.php"; ?>
								                	</td>
							                    ...
							                    <tr>
							                        ...
							                        <?= $skpi['bahasa_internasional_ind']; ?>
							                    	<?php include "pages/mahasiswa/student_skpi/upload_bahasa.php"; ?>
							                    	</td>
							                    ...
							                    <tr>
							                        ...
							                        <?= $skpi['magang_ind']; ?>
							                    	<?php include "pages/mahasiswa/student_skpi/upload_magang.php"; ?>
							                    	</td>
							                    ...
							                    <tr>
							                        ...
							                        <?= $skpi['pendidikan_karakter_ind']; ?>
							                    	<?php include "pages/mahasiswa/student_skpi/upload_pendidikan.php"; ?>
							                    	</td>
