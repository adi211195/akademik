                      <button type="button" class="btn btn-info btn-xs" data-toggle="modal" data-target="#Modalpenghargaan"><i class="fa fa-upload"></i> Upload File</button><br><br>
                        <!-- Modal -->
                        <div id="Modalpenghargaan" class="modal fade" role="dialog">
                          <div class="modal-dialog">
                        
                            <!-- Modal content-->
                            <div class="modal-content">
                              <div class="modal-header">
                                <h4 class="modal-title">Upload File Penghargaan dan Pemenang Kejuaraan</h4>
                              </div>
                              <form class="form-horizontal action" method="POST" enctype="multipart/form-data">
                              <input type="hidden" name="student_skpi_file_status" value="penghargaan">
                        ...
                        ?>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <button type="button" class="btn btn-primary btn-xs" data-toggle="modal" data-target="#penghargaanedit<?= $no; ?>"><i class="fa fa-edit"></i></button>
                                    ...
                                    <button type="button" class="btn btn-success btn-xs" data-toggle="modal" data-target="#penghargaan<?= $no; ?>"><i class="fa fa-eye"></i></button>
                                
                                    <!-- Modal -->
                                    <div id="penghargaanedit<?= $no; ?>" class="modal fade" role="dialog">
                                      <div class="modal-dialog">
                                    
                                        <!-- Modal content-->
                                        <div class="modal-content">
                                          <div class="modal-header">
                                            <h4 class="modal-title">Edit File Penghargaan dan Pemenang Kejuaraan</h4>
                                          </div>
                                          <form class="form-horizontal action" method="POST" enctype="multipart/form-data">
                                          <input type="hidden" name="student_skpi_file_status" value="penghargaan">
                                ...
                                <!-- Modal -->
                                    <div id="penghargaan<?= $no; ?>" class="modal fade" role="dialog">
                                      <div class="modal-dialog">
                                    
                                        <!-- Modal content-->
                                        <div class="modal-content">
                                          <div class="modal-header">
                                            <h4 class="modal-title">Detail File Penghargaan dan Pemenang Kejuaraan</h4>
                                          </div>
