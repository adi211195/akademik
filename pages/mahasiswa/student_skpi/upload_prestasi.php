                      <button type="button" class="btn btn-info btn-xs" data-toggle="modal" data-target="#Modalprestasi"><i class="fa fa-upload"></i> Upload File</button><br><br>
                        <!-- Modal -->
                        <div id="Modalprestasi" class="modal fade" role="dialog">
                          <div class="modal-dialog">
                        
                            <!-- Modal content-->
                            <div class="modal-content">
                              <div class="modal-header">
                                <h4 class="modal-title">Upload File Prestasi dan Penghargaan</h4>
                              </div>
                              <form class="form-horizontal action" method="POST" enctype="multipart/form-data">
                              <input type="hidden" name="student_skpi_file_status" value="prestasi">
                        ...
                        ?>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <button type="button" class="btn btn-primary btn-xs" data-toggle="modal" data-target="#prestasiedit<?= $no; ?>"><i class="fa fa-edit"></i></button>
                                    ...
                                    <button type="button" class="btn btn-success btn-xs" data-toggle="modal" data-target="#prestasi<?= $no; ?>"><i class="fa fa-eye"></i></button>
                                
                                    <!-- Modal -->
                                    <div id="prestasiedit<?= $no; ?>" class="modal fade" role="dialog">
                                      <div class="modal-dialog">
                                    
                                        <!-- Modal content-->
                                        <div class="modal-content">
                                          <div class="modal-header">
                                            <h4 class="modal-title">Edit File Prestasi dan Penghargaan</h4>
                                          </div>
                                          <form class="form-horizontal action" method="POST" enctype="multipart/form-data">
                                          <input type="hidden" name="student_skpi_file_status" value="prestasi">
                                ...
                                <!-- Modal -->
                                    <div id="prestasi<?= $no; ?>" class="modal fade" role="dialog">
                                      <div class="modal-dialog">
                                    
                                        <!-- Modal content-->
                                        <div class="modal-content">
                                          <div class="modal-header">
                                            <h4 class="modal-title">Detail File Prestasi dan Penghargaan</h4>
                                          </div>
                                          ...
                                          <div class="modal-body">
                                             ...
                                             <span>File</span><br>
                                             <b><a href="download_file.php?act=skpi&file=<?= $account_id; ?>!<?= $a['student_skpi_file_id']; ?>" target="_blank"> <?= $a['student_skpi_file']; ?> </b>
                                          </div>
                                          <div class="modal-footer">
                                            <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                                          </div>
