                ...
                <div id="page-head">
					...
					<li class="active">Polling Majors</li>
                    </ol>
                    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                    <!--End breadcrumb-->
                ...
                $action="pages/mahasiswa/polling_majors/action.php";
                $page_detail="page.php?p=polling_majors&act=detail";
                $page_list="page.php?p=polling_majors&act=list";
                $page_input="page.php?p=polling_majors&act=input";
                $page_edit="page.php?p=polling_majors&act=edit";
                $back="page.php?p=polling_majors";
                ...
                <div id="page-content">
					    ...
					    <div class="panel">
					        <div class="panel-body">
					        	...
					        	$where="WHERE polling_title like '%$search%' AND majors_code='$mhs[majors_code]'";
					        	...
					        	<?php } else {
					        		$search="";
					        		$filter="";
					        		$where="WHERE majors_code='$mhs[majors_code]'";
					        		$data=mysqli_query($connect, "SELECT * FROM polling_majors $where
					            	order by create_date desc");
                ...
                $row=mysqli_fetch_array(mysqli_query($connect,"SELECT polling_majors.*, account.account_photo, account.account_email, account.account_status FROM polling_majors 
					            	LEFT JOIN account ON account.account_id=polling_majors.account_id
					            	WHERE polling_id='$id' AND majors_code='$mhs[majors_code]'"));
