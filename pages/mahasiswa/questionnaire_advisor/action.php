...
switch ($action) {	
		...
		case 'question':
			...
			$remove=mysqli_query($connect, "DELETE FROM questionnaire_report_advisor  
						where q_advisor_id='$question_id'
						AND school_year='$school_year'
						AND semester='$semester'
						AND student_nim='$student_nim'");

			$save=mysqli_query($connect, "INSERT INTO questionnaire_report_advisor (
						qr_advisor_id,
						q_advisor_id,
						q_advisor_answer,
						student_nim,
		...
		case 'finish':
			...
			$update=mysqli_query($connect, "UPDATE questionnaire_report_advisor SET 
						qr_status='finish' 
