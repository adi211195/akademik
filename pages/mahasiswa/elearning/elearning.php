			<div id="content-container">
                ...
                $action="pages/mahasiswa/elearning/action.php";
					            ...
					            <div class="fixed-fluid">
					                <div class="fluid file-panel">
					                    ...
					                    <ul id="demo-mail-list" class="file-list">
										  ...
										  <?php
										  if (empty($folder)) {
						                       $data=mysqli_query($connect, "SELECT mc.*, mct.*, mclass.*, mcourses.*, mlecturer.*, mlecturer.account_id as act FROM master_krs as mk, 
