                ...
                <div id="page-head">
					...
					<li class="active">Forum Majors </li>
                    </ol>
                    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                    <!--End breadcrumb-->				    
                ...
                $action="pages/mahasiswa/forum_majors/action.php";
                $page_detail="page.php?p=forum_majors&act=detail";
                $page_list="page.php?p=forum_majors&act=list";
                $page_input="page.php?p=forum_majors&act=input";
                $page_edit="page.php?p=forum_majors&act=edit";
                $back="page.php?p=forum_majors";
                ...
                <div id="page-content">
					    ...
					    <div class="panel">
					        <div class="panel-body">
					        	...
					        	$where="WHERE forum_title like '%$search%' AND majors_code='$mhs[majors_code]'";
						        ...
						        <div class="col-xs-12">
						            <div class="panel">
						                <div class="panel-heading">
						                    <h3 class="panel-title">Forum Majors Data</h3>
						                </div>
						                    ...
						                    <div class="table-responsive">
						                       <table id="demo-dt-basic" class="table table-striped table-bordered" cellspacing="0" width="100%">
						                            ...
						                            <tbody>
						                            	<?php
						                            	$no=1;
						                            	$data=mysqli_query($connect, "SELECT * FROM forum_majors 
						                            		LEFT JOIN account ON account.account_id=forum_majors.account_id 
						                            		WHERE majors_code='$mhs[majors_code]' AND forum_majors.account_id='$account_id'
						                            		order by forum_majors.create_date desc");
						                            	while ($row=mysqli_fetch_array($data)) {
                ...
                $row=mysqli_fetch_array(mysqli_query($connect,"SELECT * FROM forum_majors where forum_id='$id' AND account_id='$account_id'"));
                ?>
                ...
                $row=mysqli_fetch_array(mysqli_query($connect,"SELECT forum_majors.*, account.account_photo, account.account_email, account.account_status FROM forum_majors 
					            	LEFT JOIN account ON account.account_id=forum_majors.account_id
					            	WHERE forum_id='$id' AND majors_code='$mhs[majors_code]'"));
