...
switch ($action) {	
		...
		case 'question':
			...
			$remove=mysqli_query($connect, "DELETE FROM questionnaire_report_lecturer  
						where q_lecturer_id='$question_id'
						AND curriculum_id='$curriculum_id'
						AND school_year='$school_year'
						AND semester='$semester'
						AND student_nim='$student_nim'");

			$save=mysqli_query($connect, "INSERT INTO questionnaire_report_lecturer (
						qr_lecturer_id,
						q_lecturer_id,
						curriculum_id,
						q_lecturer_answer,
		...
		case 'finish':
			...
			$update=mysqli_query($connect, "UPDATE questionnaire_report_lecturer SET 
						qr_status='finish' 
