...
switch ($action) {	
		...
		case 'question':
			...
			$remove=mysqli_query($connect, "DELETE FROM questionnaire_report_general  
						where q_general_id='$question_id'
						AND school_year='$school_year'
						AND semester='$semester'
						AND student_nim='$student_nim'");

			$save=mysqli_query($connect, "INSERT INTO questionnaire_report_general (
						qr_general_id,
						q_general_id,
						q_general_answer,
						student_nim,
		...
		case 'finish':
			...
			$update=mysqli_query($connect, "UPDATE questionnaire_report_general SET 
						qr_status='finish' 
