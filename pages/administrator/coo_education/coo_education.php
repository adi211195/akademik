			<div id="content-container">
                <div id="page-head">
                    ...
                    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                    <div id="page-title">
                        <h1 class="page-header text-overflow">Educational Cooperation</h1>
                    </div>
                    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                    <!--End page url-->
					...
					<li class="active">Educational Cooperation</li>
                    </ol>
                    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                    <!--End breadcrumb-->
                ...
                <?php
                $page_input="page.php?p=coo_education&act=input";
                $page_edit="page.php?p=coo_education&act=edit";
                $back="page.php?p=coo_education";
                $action="pages/administrator/coo_education/action.php";
					        ...
					        <div class="col-xs-12">
					            <div class="panel">
					                <div class="panel-heading">
					                    <h3 class="panel-title">Educational Cooperation Data</h3>
					                </div>
					                    ...
					                    <div class="table-responsive">
					                        <table id="demo-dt-basic" class="table table-striped table-bordered" cellspacing="0" width="100%">
					                            ...
					                            <tbody>
					                            	<?php
					                            	$no=1;
					                            	$data=mysqli_query($connect, "SELECT * FROM master_cooperation WHERE cooperation_status='Education'");
               	...
               	<div id="page-content">
               		<div class="row">
               			<div class="col-sm-12">
					        <div class="panel">
					            <div class="panel-heading">
					                <h3 class="panel-title">Add Educational Cooperation</h3>
					            </div>
					            ...
					            <form class="form-horizontal action" method="POST"  enctype="multipart/form-data">
					            	...
					            	<input type="hidden" name="cooperation_status" value="Education">
					                <div class="panel-body">
                	...
                	<div id="page-content">
               		<div class="row">
               			<div class="col-sm-12">
					        <div class="panel">
					            <div class="panel-heading">
					                <h3 class="panel-title">Edit Educational Cooperation</h3>
					            </div>
