                ...
                <?php
                $action="pages/administrator/forum_general/action.php";
					            ...
					            ?>  
					                ...
					                <li class="list-group-item list-item-lg">
					                    <div class="media-heading">
					                        <a class="btn-link text-lg text-semibold" href="<?= $page_detail; ?>&id=<?= $row['forum_id']; ?>"><?= bold($row['forum_title'],$search); ?></a>
					                    </div>
					                    ...
					                    <div class="pad-btm">
					                        <small><?= $row['create_date']; ?> <i class="demo-pli-speech-bubble-5 icon-fw"></i><?= $comment; ?>, Author :</small> 
                ...
                $row=mysqli_fetch_array(mysqli_query($connect,"SELECT * FROM forum_general where forum_id='$id'"));
                ?>
