			<div id="content-container">
                ...
                $back="page.php?p=ips";
                $page_print="pages/administrator/ips/report_pdf.php";
                $action="pages/administrator/ips/action.php";
					   ...
					   <div class="panel">
					    <div class="panel-body">
					        ...
					        <div class="text-right no-print">
					            <div class="text-right no-print">
					            <a href="<?= $page_print; ?>?nim=<?= $student_nim; ?>&sy=<?= $school_year; ?>&sm=<?= $semester; ?>" class="btn btn-danger" target="_blank"><i class="fa fa-print"></i> Export PDF</a>
					        </div>
					        </div>
