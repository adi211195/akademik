	...
	<table width="100%">
		<tr>
            ...
            <td align="right" width="50%" rowspan="5"><font size="20px">Kartu Peserta <br> 
                      <b>UJIAN AKHIR SEMESTER</b></font></td>
        </tr>
        <tr>
            <td>Program Studi</td>
		...
		<table width="100%" rules="all" style="border:1px solid black;">
			...
			while ($row=mysqli_fetch_array($data)) {
				...
				$cm=mysqli_fetch_array(mysqli_query($connect, "SELECT * FROM master_curriculum as mc
					LEFT JOIN master_curriculum_uas as mct ON mct.curriculum_id=mc.curriculum_id
					LEFT JOIN master_class as mclass ON mclass.class_code=mct.uas_class_code
			...
			?>
				<tr>
					...
					<td><?= $cm['uas_date']; ?>, <?= substr($cm['uas_start'],0,5); ?> - <?= substr($cm['uas_end'],0,5); ?></td>
					<td></td> 
                    <td></td>
...
$dompdf->render();
$dompdf->stream('KPU UAS ALL.pdf',array('Attachment'=>0));
