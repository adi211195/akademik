			<div id="content-container">
                <div id="page-head">
                    ...
                    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                    <div id="page-title">
                        <h1 class="page-header text-overflow">KRS Personal</h1>
                    </div>
                    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                    <!--End page title-->
					...
					<li class="active">KRS Personal</li>
                    </ol>
                    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                    <!--End breadcrumb-->
                ...
                $page_input="page.php?p=krs_personal&act=input&code=".$code['majors_code']."&sy=".$sy."&sm=".$sm;
                $page_edit="page.php?p=krs_personal&act=edit&code=".$code['majors_code']."&sy=".$sy."&sm=".$sm;
                $back="page.php?p=krs_personal&code=".$code['majors_code']."&sy=".$sy."&sm=".$sm;
                $action="pages/administrator/krs_personal/action.php";
                $pages="pages/administrator/krs_package/";
                $page_uts="pages/administrator/krs_personal/report_uts_all.php";
                $page_uas="pages/administrator/krs_personal/report_uas_all.php";
					        ...
					        <div class="col-xs-12">
					            <div class="panel">
					                <div class="panel-heading">
					                    <h3 class="panel-title">KRS Personal Data</h3>
					                </div>
					                         ...
					                         <table id="demo-dt-basic" class="table table-striped table-bordered" cellspacing="0" width="100%">
					                            ...
					                            <tbody>
					                                ...
					                                <tr>
					                                    ...
					                                    <td>
					                                    	<button class="btn btn-danger" id="remove" value="<?= $row['krs_id']; ?>" onclick="data_remove(this.value);" title="Remove">
				  ...
				  <div class="modal-dialog">
				    ...
				    <div class="modal-content">
				      <div class="modal-header">
				        <h4 class="modal-title">Filter KRS Personal</h4>
				      </div>
				      <form class="form-horizontal" method="GET" action="<?= $back; ?>"  enctype="multipart/form-data">
				      <input type="hidden" name="p" value="krs_personal">
				...
				<div id="page_input" class="modal fade" role="dialog">
				  <div class="modal-dialog">
				    ...
				    <div class="modal-content">
				      <div class="modal-header">
				        <h4 class="modal-title">Add KRS Personal</h4>
				      </div>
               	...
               	<div id="page-content">
               		<div class="row">
               			<div class="col-sm-12">
					        <div class="panel">
					            <div class="panel-heading">
					                <h3 class="panel-title">Add KRS Personal</h3>
					            </div>
               	...
               	<div id="page-content">
               		<div class="row">
               			<div class="col-sm-12">
					        <div class="panel">
					            <div class="panel-heading">
					                <h3 class="panel-title">Edit KRS Personal</h3>
					            </div>
                ...
                $back="page.php?p=krs_personal&act=list&nim=".$nim;
                $back2="page.php?p=krs_personal";
