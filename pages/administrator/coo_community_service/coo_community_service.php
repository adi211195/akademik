			<div id="content-container">
                <div id="page-head">
                    ...
                    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                    <div id="page-title">
                        <h1 class="page-header text-overflow">Community Service Cooperation</h1>
                    </div>
                    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                    <!--End page url-->
					...
					<li class="active">Community Service Cooperation</li>
                    </ol>
                    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                    <!--End breadcrumb-->
                ...
                <?php
                $page_input="page.php?p=coo_community_service&act=input";
                $page_edit="page.php?p=coo_community_service&act=edit";
                $back="page.php?p=coo_community_service";
                $action="pages/administrator/coo_community_service/action.php";
					        ...
					        <div class="col-xs-12">
					            <div class="panel">
					                <div class="panel-heading">
					                    <h3 class="panel-title">Community Service Cooperation Data</h3>
					                </div>
					                    ...
					                    <div class="table-responsive">
					                        <table id="demo-dt-basic" class="table table-striped table-bordered" cellspacing="0" width="100%">
					                            ...
					                            <tbody>
					                            	<?php
					                            	$no=1;
					                            	$data=mysqli_query($connect, "SELECT * FROM master_cooperation WHERE cooperation_status='Service'");
               	...
               	<div id="page-content">
               		<div class="row">
               			<div class="col-sm-12">
					        <div class="panel">
					            <div class="panel-heading">
					                <h3 class="panel-title">Add Community Service Cooperation</h3>
					            </div>
					            ...
					            <form class="form-horizontal action" method="POST"  enctype="multipart/form-data">
					            	...
					            	<input type="hidden" name="cooperation_status" value="Service">
					                <div class="panel-body">
                	...
                	<div id="page-content">
               		<div class="row">
               			<div class="col-sm-12">
					        <div class="panel">
					            <div class="panel-heading">
					                <h3 class="panel-title">Edit Community Service Cooperation</h3>
					            </div>
