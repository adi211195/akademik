...
?>
        <html>
                ...
                <table width="100%" rules="all" style="border:1px solid black;">
                  ...
                  <td  height="21"><h3 align="center">BERITA ACARA <BR> UJIAN TENGAH SEMESTER (UAS)</h3></td>                
                </tr>
                <tr>
              ...
              <table width="100%">
                ...
                <tr>
                    ...
                    <td>: <?= substr($mc['uas_start'],0,5); ?> - <?= substr($mc['uas_end'],0,5); ?></td>
                </tr>
            </table>
                      ...
                      <table width="100%">
                        <tr>
                          ...
                          <td width="30%" valign="top"> Jakarta, <?= $mc['uas_date']; ?>
...
$dompdf->render();
$dompdf->stream('BAP UAS.pdf',array('Attachment'=>0));
