                ...
                $action="pages/administrator/polling_general/action.php";
                ...
                <div id="page-content">
					    ...
					    <div class="panel">
					        <div class="panel-body">
					            ...
					            $data=mysqli_query($connect, "SELECT polling_general.*, 
					            	account.*, 
					            	date_format(polling_general.polling_start_date, '%d %b %Y') as start_date,
					            	date_format(polling_general.polling_end_date, '%d %b %Y') as end_date,
					            	date_format(polling_general.create_date, '%d %b %Y %H:%i %p') as jam
					            	FROM polling_general 
               			...
               			<div class="col-sm-12">
					        <div class="panel">
					            <div class="panel-heading">
					                <h3 class="panel-title">Add Polling General</h3>
					            </div>
                ...
                $row=mysqli_fetch_array(mysqli_query($connect,"SELECT * FROM polling_general where polling_id='$id'"));
                	...
                	<div id="page-content">
               		<div class="row">
               			<div class="col-sm-12">
					        <div class="panel">
					            <div class="panel-heading">
					                <h3 class="panel-title">Edit Polling General</h3>
					            </div>
