			<div id="content-container">
                <div id="page-head">
                    ...
                    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                    <div id="page-title">
                        <h1 class="page-header text-overflow">Transkrip</h1>
                    </div>
                    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                    <!--End page title-->
					    ...
					    <div class="panel-body">
					        <div class="invoice-masthead">
					            ...
					            <div class="invoice-text">		
					                <h3 class="h1 text-uppercase text-thin mar-no text-primary">Transkrip</h3>
					            </div>
					        </div>
					       ...
					       <?php if (!empty($student_nim) AND $check>0) { 
								...
								$skripsi=mysqli_fetch_array(mysqli_query($connect,"SELECT * FROM master_skripsi where student_nim='$student_nim'"));
					        ...
					        <div class="row">
					            <div class="col-lg-12 table-responsive">
					                <table class="table table-bordered invoice-summary">
					                    ...
					                    <tbody>
					                        ...
					                        <tr>
					                            ...
					                            <td class="text-center"><?= $row['courses_sks']; ?></td>
					                            <td class="text-center"><?= $row['courses_sks']*$row['score_quality']; ?></td>
			                        ...
			                        <div style="padding:2px; border:1px solid black; width:100%;">
			                            <b><u>Judul Skripsi </u> : <?= $skripsi['skripsi_title']; ?></b>
			                        </div>
			                        <br>
					            </div>
					        </div>
					        ...
					        <?php
                              ...
                              $ba=mysqli_fetch_array(mysqli_query($connect,"SELECT * FROM settings_range_ipk where 
                                      range_ipk_numbers<='$angka_mutu2'"));
					        ...
					        <div class="clearfix">
					            <table class="table invoice-total">
					                <tbody>
					                    <tr>
					                        <td><strong>Total satuan kredit semester (SKS) :</strong></td>
					                        <td><?= $sks; ?></td>
					                    </tr>
					                    
					                    <tr>
					                        <td><strong>Index Prestasi Komulatif (IPK) :</strong></td>
					                        <td class="text-bold h4"><?= round($quality/$sks,2); ?></td>
					                    </tr>
					                    <tr>
					                        <td><strong>P r e d i k a t :</strong></td>
					                        <td><?= $ba['range_ipk_status']; ?></td>
					                    </tr>
					                </tbody>
					            </table>
					        </div>
				  ...
				  <div class="modal-dialog">
				    ...
				    <div class="modal-content">
				      <div class="modal-header">
				        <h4 class="modal-title">Search Transkrip</h4>
				      </div>
